...
| Mốc thời gian | Ngày |
|---|---|
| ⏰ Hạn nộp báo cáo tóm tắt (abstract) | **24/03/2026** |
| 🎤 Phiên báo cáo tại các Bộ môn (dự kiến) | **1-3/04/2026** |
| 🎤 Phiên toàn thể cấp Khoa (dự kiến) | **10/04/2026** |

## 📝 Hướng dẫn nộp bài

1. **Tải mẫu abstract** và xem hướng dẫn tại thư mục [`templates/`](./templates/)
...
4. **Hạn nộp tóm tắt: 17h00, 24/03/2026**
...
- Viễn thám & GIS trong khí tượng thuỷ văn
- Mô hình số trị khí quyển và đại dương
- Ứng dụng các phương pháp Machine Learning/AI trong nghiên cứu lĩnh vực KT-TV-HDH
